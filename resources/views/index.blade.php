        ...
        <div id="nav-top">
            <div class="container">
                ...
                <ul class="nav-social">
                     ...
                     <li><h3 style="font-family: Dubai"> <a href="/"><i ></i>{{$site_name}}</a></h3></li>
        ...
        <div id="hot-post" class="row hot-post">
            <div class="col-md-8 hot-post-left">
                ...
                <div class="post post-thumb">
                    <a class="post-img" href="#"><img src="{{$first_post->image}}" alt=""></a>
                    <div class="post-body">
            ...
            <div class="col-md-4 hot-post-right">
                ...
                <div class="post post-thumb">
                    ...
                    <div class="post-body">
                        ...
                        <h3 class="post-title title-lg"><a href="#">{{$second_post->title}}</a></h3>
                        <ul class="post-meta">
                            {{--<li><a href="author.html">John Doe</a></li>--}}
