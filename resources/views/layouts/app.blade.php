                    ...
                    <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item">
                                    <a class="dropdown-item" href="{{route('tags')}}">Show Tag</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item">
                                    ...
                                    <a class="dropdown-item" href="{{route('posts')}}">Posts List</a>
                                    <a class="dropdown-item" href="{{route('trashed')}}">Deleted posts</a>
